...
areas = (lambda side: power (side, 2))(*sides)   # Define area function and pass it to apply
volumes = (lambda side: power (side, 3))(*sides) # Define volume function and pass it to apply
